...
const FloatingCrowdsourced = ({ setShowWeather }) => {
  ...
  return (
    <div className="floating-crowdsourced">
      <div
        className={`hidden sm:flex flex-col z-10 absolute w-[350px] bg-white/90 backdrop-blur-sm rounded-xl shadow-lg overflow-hidden transition-all duration-300 left-1 h-[100vh] max-h-[80vh] border border-gray-200`}
      >
